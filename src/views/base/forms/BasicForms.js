              ...
              <CRow>
                <CCol xs="4">
                  <CFormGroup>
                    ...
                    <CSelect required custom name="ccmonth" id="ccmonth">
                ...
                <CCol xs="4">
                  <CFormGroup>
                    ...
                    <CSelect required custom name="ccyear" id="ccyear">
                      <option>2017</option>
                      <option>2018</option>
                      <option>2019</option>
                      <option>2020</option>
            ...
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CSelect required custom name="select" id="select">
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9" size="lg">
                    <CSelect required custom size="lg" name="selectLg" id="selectLg">
                      <option value="0">Please select</option>
                      <option value="1">Option #1</option>
                      <option value="2">Option #2</option>
                      <option value="3">Option #3</option>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CSelect required custom size="sm" name="selectSm" id="SelectLm">
                      <option value="0">Please select</option>
                      <option value="1">Option #1</option>
                      <option value="2">Option #2</option>
                      <option value="3">Option #3</option>
